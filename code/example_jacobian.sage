"""
    This is a quick example of how to compute pairings on the Jacobian.
    It uses cubical arithmetic on the Kummer surface, and resolves the sign ambiguity
    that exists there by sending along the difference point.
"""
